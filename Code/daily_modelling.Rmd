...
sch1 <- nls(len ~ schnute1(age,alpha,beta,a1,a2,y1,y2), start = list(alpha=0.2,beta=2.0, y1=y1I,y2=y2I), control=nls.control(maxiter=10000, warnOnly = T), data=grdata)
summary(sch1)
# Extract Parameters
Sch1_Pars <- coef(sch1)
```
...
power_fit <- nls(len ~ (a0 + a1 * (age^b)), start = list(a0 = a0, a1=a1, b = b), control=nls.control(maxiter=10000), data=daily_data)
